...
export async function up(knex: Knex): Promise<void> {
    ...
    .createTable("transactions", function(table: Knex.TableBuilder) {
        ...
        table.unique(["block_hash", "transaction_index"], "block_hash_transaction_index_idx");
        table.unique(["block_number", "transaction_index"], "block_number_transaction_index_idx");
    })
